...
<div class="container  rounded"> 
  ...
  <div class = "row ">
    <div class="col-6 "><h3 style="color: white;">Delhi Donors</h3></div>
    <div class="col-6"><h3 style="color: white;">Greater Noida Donors</h3></div>
  </div>
  <div class = "row ">
    <div class="col-6">
   ...
   <div class = "row ">
    <div class="col-6 "><h3 style="color: white;">Pune Donors</h3></div>
    <div class="col-6"><h3 style="color: white;">Banglore Donors</h3></div>
  </div>
  <div class = "row ">
    <div class="col-6">
      <table class="table shadow-lg p-3 mb-5 bg-light rounded ">
        ...
        <tbody class="">
           <?php 
             $stmt3 = $pdo->query("SELECT ngo_account.donor_id , donor.name , ngo_account.donationS FROM donor JOIN ngo_account WHERE donor.donor_id = ngo_account.donor_id AND ngo_account.city_id = 5");
             $rows = $stmt3->fetchAll(PDO::FETCH_ASSOC);
             $count = 1;
              foreach($rows as $row){
                echo "<tr class=''>";
   ...
   <div class="col-6">
      <table class="table shadow-lg p-3 mb-5 bg-light rounded ">
        ...
        <tbody class="">
           <?php 
             $stmt3 = $pdo->query("SELECT ngo_account.donor_id , donor.name , ngo_account.donationS FROM donor JOIN ngo_account WHERE donor.donor_id = ngo_account.donor_id AND ngo_account.city_id = 6");
             $rows = $stmt3->fetchAll(PDO::FETCH_ASSOC);
             $count = 1;
              foreach($rows as $row){
                echo "<tr class=''>";
   ...
   <div class = "row">
    <div class="col-6"><h3 style="color: white;">Mumbai Donors</h3></div>
    <div class="col-6"><h3 style="color: white;">Other City Donors</h3></div>
