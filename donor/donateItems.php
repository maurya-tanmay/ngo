...
<div class="row" >
    ...
    <div class="col-6">
      <table class="table shadow-lg p-3 mb-5 bg-light rounded ">
        <h2 style="color: white;" >ITEMS YOU CAN DONATE</h2>
    ...
    <h1 class="h3 mb-3 font-weight-normal" style="color: white;">ENTER FROM ABOVE LIST</h1>
        <p style="color: white;"> Donate Items :
