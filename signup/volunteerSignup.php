...
<head>
    ...
    <?php include("bootstrap.php"); ?>
     <link rel="stylesheet" href="volunteer_signup.css">
...
?>
    ...
    <img class="mb-4" src="../images/index/logo2.png" alt="" width="100" height="100">
        ...
        <h3 class="h3 mb-3 font-weight-normal" style="color: white;">Volunteer SIGNUP</h3>  
        ...
        <p style="color: white;">     DATE OF BIRTH    :
            <input type="date" name="date"/></p>
        <p style="color: white;">    PHONE    :
        <input type="text" name="phone"/></p>
        <p style="color: white;">    CITY     : 
