  ...
  ?>
    ...
    <div class="row">
        ...
        if(count($rows)>0){
            ...
            echo "<a class='btn btn-primary btn-lg shadow-lg p-3 mb-5 rounded ' style='width: 400px;' href='donor/transactions.php' role='button'>Check Transctions</a>";
    ...
    <div class="col-6">
      <table class="table shadow-lg p-3 mb-5 bg-light rounded ">
        <h2 style="color: white;">ITEMS YOU DONATED</h2>
